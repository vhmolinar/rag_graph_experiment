...
| AC-14 | Falha/timeout de modelo = erro tipado, sem fallback sem RAG | ✅ | T02/T07/T11 cobrem adapters anteriores; T13: `test_verifier_adapter.py`, `test_dissertative_pipeline.py::test_verifier_timeout_releases_no_unverified_answer`, `TestVerifierFailure`, `test_invalid_citation_is_regenerated_with_feedback` e `test_invalid_id_persists_fails_closed`. |
